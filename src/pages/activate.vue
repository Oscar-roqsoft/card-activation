      ...
      <main class="mx-auto max-w-7xl px-5 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div class="grid gap-8 lg:grid-cols-[1fr_420px] lg:items-start">
          ...
          <div>
            ...
            <div v-if="reveal == 1" class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7 mb-6">
            ...
            <div v-if="reveal == 2"  class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7">
